...
echo Compilacion v1.0.24.16 terminada y validada.
echo .venv\Scripts\python.exe make_update_package.py --dist dist\CodeCafe-Atlas --version 1.0.24.23 --platform windows --architecture x86_64
pause
exit /b 0
:error

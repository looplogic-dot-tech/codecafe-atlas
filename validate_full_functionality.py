...
for fragment in ("build_windows_release.py", "1.0.24.26", "release\\CodeCafe_Atlas_v1.0.24.26_Windows_x64.zip"):
...
for _fragment in ('setDisplayFormat("hh:mm:ss AP")', 'toString("hh:mm:ss AP")', '"HH:mm"'):

# CodeCafe Atlas v1.0.24.34 — Windows build and portable distro
...
6. Builds with PyInstaller in `%LOCALAPPDATA%/CodeCafeAtlasBuild/1.0.24.34`, outside synchronized source paths.
...
9. Creates `release/CodeCafe_Atlas_v1.0.24.34_Windows_x64.zip`.
